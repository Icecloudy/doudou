...
package com.lexing.passenger.views.wheelView;
...
import com.lexing.passenger.views.wheelView.adapter.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     * To apply changes and rebuild gridview_item call measure().
     *
    ...
    /**
     * Gets gridview_item adapter
     *
     * @return the gridview_item adapter
     */
    ...
    /**
     * Sets gridview_item adapter. Usually new adapters contain different views, so
     * it needs to rebuild gridview_item by calling measure().
     *
     * @param viewAdapter the gridview_item adapter
     */
    ...
    /**
     * Updates gridview_item. Rebuilds items and label if necessary, recalculate items sizes.
     */
    ...
    /**
     * Builds gridview_item for measuring
     */
    ...
    /**
     * Adds gridview_item for item to items layout
     *
     * @param index the item index
     * @param first the flag indicates if gridview_item should be first
    ...
    /**
     * Returns gridview_item for specified item
     *
     * @param index the item index
     * @return item gridview_item or empty gridview_item if index is out of bounds
     */
