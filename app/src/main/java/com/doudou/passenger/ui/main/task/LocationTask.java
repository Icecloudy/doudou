 ...
 * Package Name:com.amap.api.bottom_nav_car.example
...
public class LocationTask implements AMapLocationListener,
    ...
    public static  String province="";//上传位置
    public static  String city="";//上传位置
    public static  String area ="";//上传位置
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (amapLocation != null && amapLocation.getErrorCode() == 0) {
            ...
            if (!TextUtils.isEmpty(amapLocation.getAddress())) {
                ...
                if (entity.address.contains("市")) {
                    entity.address = entity.address.substring(entity.address.indexOf("市") + 1, entity.address.length());
                }
